...
- En las actividades de OT, `vehicle_category_id` y `vehicle_type` se derivan del vehículo asociado al equipo. La ubicación técnica se limita simultáneamente a esa categoría, ese tipo de vehículo y el nivel 0; el selector de actividad exige la categoría del vehículo y la ubicación técnica seleccionada. Mantener también onchange y constraints ORM equivalentes.
- La pestaña **Actividades** de la OT mantiene el ingreso manual línea a línea y agrega el asistente **Agregar varias actividades**. El asistente toma automáticamente la categoría y el tipo del vehículo y precarga solo actividades compatibles cuya ubicación técnica sea de nivel 0; al confirmar crea una línea pendiente por cada actividad marcada, tomando su ubicación y copiando duración, instrucciones y materiales estándar. El tipo de intervención se propone desde el uso más frecuente en planes PM y puede corregirse en la grilla.
- En el encabezado de la OT, el campo estándar `category_id` se muestra como **Categoría de Equipo**, `barca_vehicle_category_id` como **Categoría de Vehículos** y `barca_vehicle_type` como **Tipo de vehículo**. Son de solo lectura y los dos últimos se derivan del vehículo asociado al equipo.
- En el encabezado de **Avisos**, `vehicle_category_id` y `vehicle_type` se muestran en solo lectura y se derivan de `vehicle_id`. En sus actividades, la ubicación técnica se limita simultáneamente a esa categoría, ese tipo de vehículo y el nivel 0; la actividad exige la categoría del vehículo y la ubicación técnica seleccionada. Mantener también onchange y constraints ORM equivalentes a los de la OT.
